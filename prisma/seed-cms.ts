  ...
  },
  {
    ...
    content: {
      items: [
        ...
        { icon: 'Home', title: 'Property Purchase Intelligence', description: '9 purchase modes with full tax implications (SDLT, IHT, CGT, Corp Tax, ATED) sourced from GOV.UK.' },
        { icon: 'Calculator', title: 'SDLT Calculator', description: 'Stamp Duty calculator with 6 buyer types and official 2025/26 tax bands.' },
        { icon: 'Banknote', title: 'Mortgage Approval Simulator', description: 'Probability scoring based on age, employment, income, debts, credit, and deposit.' },
        { icon: 'Brain', title: 'Property Purchase Planner', description: 'AI-powered plan using your real financial data with investment projections and entity strategy.' },
        { icon: 'LineChart', title: 'Investment Projections', description: 'Compound interest engine for ISAs, stocks, pensions, bonds with dividend tracking.' },
        { icon: 'Target', title: 'Savings Plan Generator', description: 'Personalised deposit savings plan with scenario modelling and milestones.' },
        { icon: 'PiggyBank', title: 'Mortgage Affordability', description: 'Max borrowing calculator at 4x and 4.5x salary with monthly payment breakdown.' },
        { icon: 'Shield', title: 'Credit Score Hub', description: 'UK credit scoring across Experian, Equifax, TransUnion with improvement tips.' },
      ],
    },
    sortOrder: 2,
  },
  {
    sectionKey: 'propertyIntelligence',
    title: 'Plan Your Property Purchase with AI-Powered Intelligence',
    subtitle: 'Property Purchase Intelligence',
    content: {
      description: 'From first-time buyers to seasoned investors — our suite of property tools analyses your real financial data, projects investment growth with compound interest, and maps cross-entity strategies for the smartest route to homeownership.',
      features: [
        { icon: 'Home', title: '9 Purchase Modes', description: '9 purchase modes compared — personal, joint tenants, tenants in common, Ltd company (SPV), trust, charity, pension (SSAS/SIPP), shared ownership, right to buy. Full tax implications sourced from GOV.UK.' },
        { icon: 'Calculator', title: 'SDLT Calculator', description: 'Stamp Duty Land Tax calculator with 6 buyer types — first-time, additional property, company, non-resident, corporate. Official 2025/26 tax bands.' },
        { icon: 'Banknote', title: 'Mortgage Approval Simulator', description: 'Estimate your mortgage chances based on age, employment type, income, debts, credit score, deposit, and property type. Probability gauge, stress test, red flags, and lender suitability.' },
        { icon: 'Brain', title: 'AI Purchase Planner', description: 'Reads your real accounts, entities, transactions, debts, and savings goals. Mortgage Readiness Score, deposit timeline, and personalised milestones.' },
        { icon: 'LineChart', title: 'Investment Projections', description: 'Compound interest engine for Cash ISAs, Stocks & Shares ISAs, pensions, bonds, stocks, company retained profits. Tracks dividends, reinvestment, and monthly contributions.' },
        { icon: 'Building2', title: 'Cross-Entity Strategy', description: 'Salary vs dividends optimisation, SPV purchase analysis, director\'s loan rules (S.455), retained profits extraction — personal vs company purchase intelligence.' },
        { icon: 'Target', title: 'Savings Plan Generator', description: 'Personalised savings plan based on your real income and expenses. Scenario modelling — see how expense cuts or partner income changes your timeline.' },
        { icon: 'Shield', title: 'Credit Score Hub', description: 'UK credit scoring explained across Experian, Equifax and TransUnion. Score bands, impact factors, 8 improvement tips with timelines, and Experian API integration info.' },
      ],
      ctaPrimary: 'Plan Your Purchase',
      ...
      mockup: {
        ...
        monthlyCapacity: 850,
        etaDeposit: 'Mar 2027',
        investmentGrowth: { today: 12000, projected: 19400, months: 36 },
        entityStrategy: { name: 'Tech Solutions Ltd', balance: '£22k', strategy: 'dividend extraction strategy available' },
      },
    },
    sortOrder: 3,
  },
